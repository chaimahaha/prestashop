...
class AdminContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'prestashop_database', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.6.1', '/var/www/html', true);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.6.1', '/var/www/html');
    }
    ...
    {
        return [
            'database_host' => 'prestashop_database',
            'database_port' => '',
            ...
            'secret' => 'reN8vubUmHI8EdnzAbjVmZL0YWOH0axiYwNa0wVWGF5zdRrgFNpW4Dcn',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-09-22',
            'locale' => 'fr-FR',
            'cookie_key' => '8YrhUsQVGa2uZdnJsxNpjEJb2RnNLKucQe9CWgyp98NE9poetzKwNrhp',
            'cookie_iv' => 'yc5aeXcx',
            'new_cookie_key' => 'def0000052f09761ea22971be26e9f0f594897f9619c4e77d38ca9134a54501d3ec61d1c16293728aaae1786cb02d5c8fb12ed568e3cc0b2b0470444e0195b2c81a84b6f',
            'cache.driver' => 'array',
            'kernel.bundles' => [
