...
$modulesToTest = ['gsitemap', 'dashproducts', 'fakemodule', 'existing-headers-discrimination', 'smart-headers'];
$workspaceID = 100;
...
foreach ($modulesToTest as $moduleName) {
    ...
    $commandParameters = ['command' => 'prestashop:licenses:update', '--license' => __DIR__ . '/../../../assets/afl.txt', '--target' => $workspaceFolderpath, '--not-name' => '*.min.js', '--exclude' => 'ignoredFolder'];
