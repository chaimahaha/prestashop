...
use ps_metrics_module_v4_0_6\PHP_CodeSniffer\Tests\FileList;
use ps_metrics_module_v4_0_6\PHPUnit\Framework\TestSuite;
use ps_metrics_module_v4_0_6\PHPUnit\TextUI\TestRunner;
class AllTests
{
    /**
