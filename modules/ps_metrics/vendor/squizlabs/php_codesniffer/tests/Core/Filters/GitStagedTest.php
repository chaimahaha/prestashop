...
use ps_metrics_module_v4_0_6\PHP_CodeSniffer\Filters\GitStaged;
...
final class GitStagedTest extends AbstractFilterTestCase
{
    ...
    public function testFileNamePassesAsBasePathWillTranslateToDirname()
    {
        ...
        $mockObj = $this->getMockedClass('ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Filters\\GitStaged', $constructorArgs, ['exec']);
