 ...
 */
namespace ps_metrics_module_v4_0_6\PHP_CodeSniffer\Tests\Core\Filters;

use ps_metrics_module_v4_0_6\PHP_CodeSniffer\Filters\GitModified;
use ps_metrics_module_v4_0_6\PHP_CodeSniffer\Tests\Core\Filters\AbstractFilterTestCase;
...
final class GitModifiedTest extends AbstractFilterTestCase
{
    ...
    public function testFileNamePassesAsBasePathWillTranslateToDirname()
    {
        ...
        $mockObj = $this->getMockedClass('ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Filters\\GitModified', $constructorArgs, ['exec']);
