...
final class RuleInclusionAbsoluteLinuxTest extends TestCase
{
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
        // Test that the sniff properties are correctly set.
        $this->assertSame('10', $this->ruleset->sniffs['PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff']->spacing);
    }
