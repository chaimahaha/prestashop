...
final class ShowSniffDeprecationsTest extends TestCase
{
    ...
    public function testDeprecatedSniffsListDoesNotShowWhenAllDeprecatedSniffsAreExcluded()
    {
         ...
         */
        $exclusions = [];
        $exclude = ['Fixtures.Deprecated.WithLongReplacement', 'Fixtures.Deprecated.WithoutReplacement', 'Fixtures.Deprecated.WithReplacement', 'Fixtures.Deprecated.WithReplacementContainingLinuxNewlines', 'Fixtures.Deprecated.WithReplacementContainingNewlines'];
    ...
    public function testDeprecatedSniffsAreListedAlphabetically()
    {
        ...
        $this->assertArrayHasKey('Fixtures.Deprecated.WithoutReplacement', $ruleset->sniffCodes, 'WithoutReplacement sniff not registered');
        $this->assertArrayHasKey('Fixtures.Deprecated.WithReplacement', $ruleset->sniffCodes, 'WithReplacement sniff not registered');
    }
    ...
    {
        $exception = 'ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Exceptions\\RuntimeException';
