...
use ps_metrics_module_v4_0_6\PHP_CodeSniffer\Files\DummyFile;
...
abstract class AbstractTokenizerTestCase extends TestCase
{
    ...
    {
        $property = new ReflectionProperty('ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Tokenizers\\PHP', 'resolveTokenCache');
