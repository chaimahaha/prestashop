...
final class ResolveSimpleTokenTest extends AbstractTokenizerTestCase
{
    ...
    {
        $expectedSequence = [T_OPEN_PARENTHESIS, \T_VARIABLE, T_OPEN_SQUARE_BRACKET, \T_LNUMBER, T_CLOSE_SQUARE_BRACKET, T_CLOSE_PARENTHESIS, T_OPEN_CURLY_BRACKET, \T_CASE, \T_STRING, T_COLON, \T_BREAK, T_SEMICOLON, T_CLOSE_CURLY_BRACKET];
    ...
    {
        $expectedSequence = [T_OPEN_PARENTHESIS, T_PARAM_NAME, T_COLON, \T_VARIABLE, T_CLOSE_PARENTHESIS, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_EQUAL, T_CLOSURE, T_OPEN_PARENTHESIS, T_CLOSE_PARENTHESIS, T_COLON, \T_STRING, T_OPEN_CURLY_BRACKET, T_CLOSE_CURLY_BRACKET, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_STRING_CONCAT, \T_VARIABLE, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_EQUAL, \T_LNUMBER, T_MULTIPLY, \T_LNUMBER, T_DIVIDE, \T_LNUMBER, T_PLUS, \T_LNUMBER, T_MINUS, \T_LNUMBER, T_MODULUS, \T_LNUMBER, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', \T_VARIABLE);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    ...
    {
        $expectedSequence = [T_EQUAL, T_PLUS, \T_LNUMBER, T_DIVIDE, T_MINUS, \T_LNUMBER, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', \T_VARIABLE);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    ...
    {
        $expectedSequence = [T_EQUAL, \T_STRING, T_BITWISE_XOR, \T_STRING, T_BITWISE_AND, \T_STRING, T_BITWISE_OR, \T_STRING, T_BITWISE_NOT, \T_STRING, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', \T_VARIABLE);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    ...
    {
        $expectedSequence = [T_OPEN_PARENTHESIS, \T_STRING, T_BITWISE_OR, \T_STRING, \T_VARIABLE, T_CLOSE_PARENTHESIS, T_OPEN_CURLY_BRACKET, T_CLOSE_CURLY_BRACKET];
    ...
    {
        $expectedSequence = [T_LESS_THAN, \T_VARIABLE, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_GREATER_THAN, \T_VARIABLE, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', \T_LNUMBER);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    //end testGreaterThan()
    ...
    {
        $expectedSequence = [T_BOOLEAN_NOT, \T_VARIABLE, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_COMMA, \T_VARIABLE, T_COMMA, \T_VARIABLE, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', \T_VARIABLE);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    //end testComma()
    ...
    {
        $expectedSequence = [T_ASPERAND, \T_STRING, T_OPEN_PARENTHESIS, T_CLOSE_PARENTHESIS, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', T_EQUAL);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    //end testAsperand()
    ...
    {
        $expectedSequence = [T_DOLLAR, T_OPEN_CURLY_BRACKET, \T_VARIABLE, T_CLOSE_CURLY_BRACKET, T_SEMICOLON];
    ...
    {
        $expectedSequence = [T_BACKTICK, \T_ENCAPSED_AND_WHITESPACE, T_BACKTICK, T_SEMICOLON];
        $target = $this->getTargetToken('/* ' . __FUNCTION__ . ' */', T_EQUAL);
        $this->checkTokenSequence($target + 1, $expectedSequence);
    }
    //end testBacktick()
    ...
    private function checkTokenSequence($startPtr, array $expectedSequence)
    {
        ...
        for ($i = $startPtr; $sequenceKey < $sequenceCount; $i++) {
            ...
            $this->assertSame($expectedSequence[$sequenceKey], $tokens[$i]['code'], 'Token tokenized as ' . Tokens::tokenName($tokens[$i]['code']) . ', not ' . $expectedTokenName . ' (code)');
            $this->assertSame($expectedTokenName, $tokens[$i]['type'], 'Token tokenized as ' . $tokens[$i]['type'] . ', not ' . $expectedTokenName . ' (type)');
            ++$sequenceKey;
        }
        //end for
    }
