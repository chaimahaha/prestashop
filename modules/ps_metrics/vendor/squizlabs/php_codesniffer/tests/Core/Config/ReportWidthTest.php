 ...
 */
namespace ps_metrics_module_v4_0_6\PHP_CodeSniffer\Tests\Core\Config;
...
final class ReportWidthTest extends TestCase
{
    ...
    {
        $property = new ReflectionProperty('ps_metrics_module_v4_0_6\\PHP_CodeSniffer\\Config', $name);
